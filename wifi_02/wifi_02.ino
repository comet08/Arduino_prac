 ...
 */ 
 ...
 void setup() {   
  ...
  delay(1000); 
   ...
   sendData("AT+CWJAP=\"test\",\"123456789\"",10000,DEBUG);   
 ...
 void loop() {   
  if( millis() - lastTimeMillis > 15000) {     
    lastTimeMillis = millis(); 
     mySerial.println("AT+CIPSTART=4,\"TCP\",\"myweb.jnu.ac.kr\",80");     
     delay(1000);     
     while(mySerial.available()){       
     ...
     String cmd = ""; 
     if(state == 0){       
      cmd = "GET /~kbkim/data/temp/test1.c";       
      state = 1;     
     } 
     else {       
      cmd = "GET /~kbkim/data/temp/thread.c";       
      state = 0;     
     }     
